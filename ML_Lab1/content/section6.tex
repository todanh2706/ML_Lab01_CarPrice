...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{img/web1.png}
    \caption{Giao diện chính của ứng dụng web - 1} 
    \label{fig:placeholder}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{img/web2.png}
    \caption{Giao diện chính của ứng dụng web - 2}
    \label{fig:placeholder}
\end{figure}
